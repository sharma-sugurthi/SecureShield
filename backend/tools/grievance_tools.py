...
def generate_claim_report_pdf(
    ...
    filename = f"PolicyEye_Report_{patient_name.replace(' ', '_')}_{timestamp}.pdf"
    ...
    # --- Header ---
    elements.append(Paragraph("🛡️ PolicyEye — Claim Eligibility Report", title_style))
    ...
    elements.append(Paragraph(
        "This report was generated by PolicyEye Agentic AI. "
...
async def search_insurer_gro_email(insurer: str) -> dict:
    ...
    # Prioritize reliable domains to filter out SEO junk
    query = f"official grievance redressal officer email {insurer} health insurance india site:policybazaar.com OR site:beshak.org OR site:irda.gov.in"
    ...
    if not found_email:
        # Dictionary of strictly verified GRO/Customer Support emails for major Indian Insurers
        gro_emails = {
            ...
            "max bupa": "customercare@nivabupa.com",
